/*! Animatelo | The MIT License (MIT) | Copyright (c) 2017 GibboK */ ! function(e) {
    "use strict";
    e.version = "1.0.3";
    var t = {
            duration: 1e3,
    ...
    e._animate = function(e, o, s) {
        var r = {
            ...
            m = [],
            d = [].slice.call(c);
        return i(r), d.forEach(function(e, t) {
            var n = e.animate(o, r);
...
function(e) {
    ...
    e.bounceOut = function(t, a) {
        ...
        if ("object" == typeof a && "duration" in a == !1 && (a.duration = 750), "object" != typeof a) var a = {
            duration: 750
        };
        return e._animate(t, n, a)
    }
...
function(e) {
    ...
    e.hinge = function(t, a) {
        ...
        if ("object" == typeof a && "duration" in a == !1 && (a.duration = 2e3), "object" != typeof a) var a = {
            duration: 2e3
        };
        return e._animate(t, n, a)
    }
